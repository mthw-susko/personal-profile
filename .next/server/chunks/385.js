...
const Paragraph = ({ pb , children  })=>{
    const ParagraphStyled = (_emotion_styled__WEBPACK_IMPORTED_MODULE_1___default().p)`
  text-align: justify;
  text-indent: 1em;
  margin-bottom: ${(props)=>props.pb};
  `;
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(ParagraphStyled, {
        pb: pb,
        children: children
    });
};
